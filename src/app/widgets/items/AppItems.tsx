...
function AppItems({ mp }: AppItemProp) {
  return (
    <div className='tw-pl-[5px] tw-pr-[5px] tw-pt-[10px] tw-pb-[5px] tw-flex tw-flex-col tw-w-[60px] tw-cursor-pointer tw-select-none tw-items-center tw-gap-[2px] hover:tw-bg-[#e6e6e6] tw-rounded-[4px]'> {/**#9cc2ff */}
