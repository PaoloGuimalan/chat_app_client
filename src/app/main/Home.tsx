        ...
        <div id='div_profile_search_container'>
          ...
          <div id='div_search_container'>
            <div id='div_input_container'>
              ...
              <input value={searchbox} autoComplete="off" onChange={(e) => { setsearchbox(e.target.value) }} onFocus={() => { setsearchBoxFocus(true) }} onBlur={() => { setTimeout(() => { setsearchBoxFocus(false) }, 500) }} type='text' placeholder='Search something...' id='input_search_box' />
            </div>
          </div>
        </div>
